...
$(document).on('submit' , '.ajax-form' , function () {
    ...
    form.find(":submit").attr('disabled' , true).html('<i class="fa fa-save"></i>برجاء الإنتظار');
    ...
    $.ajax({
        ...
        error : function (jqXHR) {
            ...
            form.find(":submit").attr('disabled' , false).html('<i class="fa fa-save"></i>حفظ المعلومات');
        }
    });
    $.ajaxSetup({
        headers:
